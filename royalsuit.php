...
<?php $pagetitle= 'Royal Suite' ; 
include('includes/ps_pagination1.php');?>
<?php include("includes/header2.php"); ?>


		<h1 style="color:#FFFFFF" >Royal Suite</h1>
	</div>
...
<?php  if(strlen($img_url1)>4){  ?> data-thumb="<?php echo $cat_part; ?>uploads/<?php echo $img_url1;  ?>"><img style="width:900px; height:500px;" alt="<?php echo $cat_part['cat_name'];?>" class="img-responsive" src="<?php echo $cat_part; ?>uploads/<?php echo $img_url1;  ?>" />	<?php } } ?></a> </li>
					<?php } ?>
					...
					<div class="col-lg-2 clearfix col-sm-4">
						<div class="room-services"><br /><br /><br /><!-- Room Services -->
							...
							<ul class="room-services">
								...
								<li><i class="fa fa-wifi"></i> 750MB WI-FI ACCESS/DAY </li>
...
<?php  if(strlen($img_url1)>4){  ?>
				<img style="width:900px; height:300px;" alt="<?php echo $cat_part['cat_name'];?>" class="img-responsive" src="<?php echo $cat_part; ?>uploads/<?php echo $img_url1;  ?>" />	<?php } } ?></a> </li>
								<?php } ?></a>
								</ul>
							</div>
