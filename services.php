...
<?php include("includes/header2.php"); ?>
	...
	<div class="content"><!-- Content Section -->
		...
		$pager = new PS_Pagination($connection, $sql, 10, 10);
			...
			$x++
			?>
				<div class="col-lg-3 col-sm-6 clearfix"><!-- Explore Rooms -->
...
<?php  if(strlen($img_url1)>4){  ?>
							...
							<img style="height:320px; width:320px;" alt="Room Images" class="img-responsive" src="<?php echo SITE_PATH; ?>uploads/<?php echo $img_url1;  ?>" />	<?php } } ?>
						<div class="home-room-details">
									<h5><a href="rooms.php?catid=<?php echo $post["cat_id"]; ?>"><?php echo $post["cat_name"]; ?></a></h5>
									
								</div>
							</div>
							<div class="room-details">
								<p><?php echo substr($post["cat_description"],5,50); ?></p>
							</div>
							<div class="room-bottom">
								<div class="pull-left">
									<div class="button-style-1">
										<a href="rooms.php?catid=<?php echo $post["cat_id"]; ?>">VIEW ROOMS</a>
									</div>
								</div>
							</div>
						</div>
