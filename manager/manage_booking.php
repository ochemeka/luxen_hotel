...
redirect_to("manage_booking.php?status=asuccess");
}
}
...
?>		
 ...
 <?php  
	 ...
	 $page_url           = "<?php echo ADMIN_PATH ; ?>bookingtbl";
...
$results = $connection->query("SELECT * FROM bookingtbl ORDER BY book_id ASC LIMIT $page_position, $item_per_page");
...
<?php } } ?>
                                               ...
                                               <td><?php echo timeAgo1(get_date_2a($row['time']));?></td>
												...
												<td>(<?php if($row['pay_confirm']==1){ ?><a href="manage_booking.php?disapprove=<?php echo $row['book_id']; ?>" onClick="return confirm('Are you sure?');">Disapprove</a><?php }else{ ?><a href="manage_booking.php?approve=<?php echo $row['book_id']; ?>" onClick="return confirm('Are you sure?');">Approve</a><?php } ?> )&nbsp;(<a href="manage_booking.php?delete=<?php echo $row['book_id']; ?>" onClick="return confirm('Are you sure?');">Delete</a>)&nbsp;<a href="manage_editbooking.php?booking=<?php echo $row['book_id']; ?>">Edit</a></td>
												</tr>
	<?php
