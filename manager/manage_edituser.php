...
<form method="post" action="manage_edituser.php?pid=<?php echo $_GET["pid"]; ?>" enctype="multipart/form-data">
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" class="form-control"  placeholder="please enter your username" name="username" value="<?php echo $user_part['username']; ?>">
                    </div>
                    																	
					
                <div class="form-group">
                      <label for="exampleInputEmail1">Email:</label>
                       <input type="text" class="form-control"  placeholder="Phone Number" name="email" value="<?php echo $user_part['email']; ?>">
                    </div>												
																			
					 <div class="form-group">
                      <label for="exampleInputEmail1">Phone:</label>
                      <input type="text" class="form-control"  placeholder="Phone Number" name="phone" value="<?php echo $user_part['phone']; ?>">
                    </div>
				 ...
				 <div class="row">
						...
						<div class="col-xs-6">
						 <label for="exampleInputEmail1">Address:</label>
						  <input class="form-control" placeholder="Enter New Address" type="text" name="address" value="<?php echo $user_part['address']; ?>">
						</div>
