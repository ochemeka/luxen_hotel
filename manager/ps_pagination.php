...
class PS_Pagination {
	...
	function renderFirst($tag = 'First') {
		...
		if ($this->page == 1) {
			return '<li class="disabled"><a href="' . $this->php_self . '?page=1&' . $this->append . '">' . $tag . '</a></li> ';
		} else {
	...
	function renderNext($tag = '&gt;&gt;') {
		...
		if ($this->page < $this->max_pages) {
			...
			return '<a href="' . $this->php_self . '?page=' . ($this->page + 1) . '&' . $this->append . '">' . $tag . '</a></li>';
		}
	}
	...
	function renderPrev($tag = '&lt;&lt;') {
		...
		if ($this->page > 1) {
			...
			return '<li class="disabled"><a href="' . $this->php_self . '?page=' . ($this->page - 1) . '&' . $this->append . '">' . $tag . '</a></li>';
		}
	}
	...
	function renderNav($prefix = '<li>', $suffix = '</li>') {
		...
		for($i = $start; $i <= $end; $i ++) {
			if ($i == $this->page) {
				$links .= ' ' . $prefix . ' <li class="active"><a href="' . $this->php_self . '?page=' . $i . '&' . $this->append . '">' . $i . '</a></li>' . $suffix . ' ';
			} else {
