...
redirect_to("manage_gallery.php?status=asuccess");
}
}
...
?>	
 ...
 <table id="example" class="display table table-hover table-condensed" cellspacing="0" width="100%">
	...
	<?php  
	 ...
	 $page_url           = "<?php echo ADMIN_PATH ; ?>gal";
...
<?php } } ?>      </td>
												...
												<td>(<?php if($row['gal_status']==1){ ?><a href="manage_gallery.php?disapprove=<?php echo $row['gal_id']; ?>" onClick="return confirm('Are you sure?');">Disapprove</a><?php }else{ ?><a href="manage_gallery.php?approve=<?php echo $row['gal_id']; ?>" onClick="return confirm('Are you sure?');">Approve</a><?php } ?> )&nbsp;(<a href="manage_gallery.php?delete=<?php echo $row['gal_id']; ?>" onClick="return confirm('Are you sure?');">Delete</a>)&nbsp;<a href="manage_editgallery.php?gallery=<?php echo $row['gal_id']; ?>">Edit</a></td>
												</tr>
	<?php
...
<table style="border:hidden;" border="0";></table>
